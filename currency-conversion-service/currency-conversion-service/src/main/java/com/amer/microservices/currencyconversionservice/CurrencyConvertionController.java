...
public class CurrencyConvertionController {
    ...
    public CurrencyConversionBean convertCurrency(@PathVariable String from , @PathVariable  String to , @PathVariable BigDecimal quantity){
        ...
        return new CurrencyConversionBean( response.getId(),from , to ,  response.getConversionMultible() , quantity,quantity.multiply(response.getConversionMultible()) , response.getPort());
    }
